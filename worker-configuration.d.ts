/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 180b9a18b0248d479fdfc4238c039fe7)
// Runtime types generated with workerd@1.20260205.0 2026-02-05 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReserveDurableObject";
	}
	interface ProductionEnv {
		reserve: D1Database;
		RESERVE_DO: DurableObjectNamespace<import("./src/index").ReserveDurableObject>;
	}
	interface Env {
		reserve: D1Database;
		RESERVE_DO: DurableObjectNamespace<import("./src/index").ReserveDurableObject>;
